...
const Towers = () => {
  ...
  const { data, error, isLoading } = useSWR(
    'https://grandavenue.ru/api/towers',
    fetcher
  );
    ...
    <section className='page towers'>
      ...
      >
        <path
          ...
          className={activeTower == 1 ? 'active' : ''}
        ...
        <path
          ...
          className={activeTower == 3 ? 'active' : ''}
        ...
        <path
          ...
          className={activeTower == 2 ? 'active' : ''}
        ...
        <path
          ...
          className={activeTower == 6 ? 'active' : ''}
        ...
        <path
          ...
          className={activeTower == 5 ? 'active' : ''}
        ...
        <path
          ...
          className={activeTower == 4 ? 'active' : ''}
      ...
      {towers.map((point) => (
        <div
          key={point.id}
          className={
            activeTower == point.id ? 'towers__point active' : 'towers__point'
          }
          id={point.id}
          style={{
            left: `${point.left}`,
      ...
      <div className='container'>
        <div className='towers__title'>
          <h1>6 видовых башен</h1>
          <p>
            Небольшой описательный текст локации, её расположения, окружения и
            атмосферы
          </p>
        </div>
      </div>
